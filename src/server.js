const express = require("express") //está requerindo o express do json para fazer o server
...
if(search == "") {
    ...
    db.all(`SELECT name FROM places WHERE city LIKE '%${search}%'`, function(err, rows) {
        ...
        console.log(rows) //ele tirou mas recomendou deixar pra ver se os dados estão chegando
